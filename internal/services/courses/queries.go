...
func (s *service) GetCoursesByParams(ctx context.Context, params *entity.GetCoursesParams) ([]*entity.Course, error) {
	...
	catsIDs := lo.Map(courses, func(c *entity.Course, _ int) string {
	...
	categoriesMap := lo.SliceToMap(categories, func(t *entity.Category) (string, *entity.Category) {
		return t.ID, t
	})
...
func (s *service) GetTasksByTopicIDAndOrderNum(
	...
	solution, _, err := s.taskSubmissionRepository.GetSolvedTasks(ctx, userID, task.ID)
	if err != nil {
		return nil, nil, err
	}
...
func (s *service) mergeCourse(ctx context.Context, course *entity.Course) error {
	...
	topicMap := lo.SliceToMap(topics, func(t *entity.Topic) (string, *entity.Topic) {
		return t.ID, t
	})
